            ...
            <div className="user-info">
                <div style={{ display: "flex" }}>
                    ...
                    <div className="information">
                        <p className="p1">下午好，
                            <Link to="/user/account/person"> <span className="name">{userInfo.nickName}</span></Link>
                        </p>
                ...
                <div className="right">
                    ...
                    <div style={{ textAlign: "center" }}>
                        ...
                        <p style={{ fontSize: 12 }}>请联系管理员授权</p>
                    </div>
                </div>
            </div>
                            ...
                            <div className="star-list">
                                {
                                    recentStar.map((item: any) => (
                                        <div className="item" key={item.id}>
                                            <Link to={`/client/house/${item?.id}`}>
                                                <div className="img">
                                                    <img height={190} width="100%" src={item?.cover} alt="" />
                                                </div>
                                                <div className="info">
