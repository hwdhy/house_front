...
import WeChatCodePng from "@assets/img/weixin.jpg";
                ...
                <div className="top-item">
                    <div className="left-list">
                        <div className="item">
                            ...
                            <a rel="noopener noreferrer" target="_blank" href="">d</a>
                            <a rel="noopener noreferrer" target="_blank" href="">h</a>
                            <a rel="noopener noreferrer" target="_blank" href="">y</a>
                        </div>
                        <div className="item">
                            <div className="title">关注我们</div>
                            <a rel="noopener noreferrer" target="_blank" href="">1</a>
                            <a rel="noopener noreferrer" target="_blank" href="">2</a>
                        </div>
                    </div>
                    <div className="right-code">
                        <div className="img">
                            <img src={WeChatCodePng} onError={(e: any) => { e.target.src = WeChatCodeCielPng; e.target.onerror = null; }} />
                            <p>扫码联系管理员</p>
                        </div>
                    </div>
                </div>
