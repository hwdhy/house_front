        ...
        <Container fixed={fixed}>
            <div className="content">
                ...
                <div className="tab-menu">
                    ...
                    <div className="item"><Link to={"/client/home"}> <span className="title"> 租厂房 <span className="underline" /></span></Link></div>
                    <div className="item"><Link to={"/client/home"}> <span className="title"> 买厂房 <span className="underline" /></span></Link></div>
                </div>
                <LoginRegisterBtn />
            </div>
        </Container>
