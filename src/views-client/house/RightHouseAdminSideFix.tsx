            ...
            <div className="side-fix">
                <div className="order">
                    {
                        ...
                        <>
                            ...
                            <div className="price" style={{ marginBottom: 20 }}><span className="icon">￥</span><span className="number">{houseInfo.price} </span>/月</div>
                        </>
                    }
                ...
                <div className="admin">
                    <div className="avatar">
                        <Avatar size={60} src={agent.avatar} alt="房东">房东</Avatar>
                    </div>
                    <div className="admin-info">
                        <div className="name">联系人: {agent.nickName}</div>
                ...
                </div>
                {
                    ...
                    <div className="qrcode">
                        ...
                        <div className="code"> <img className="imgHw" src={WeChatCodePng} alt="管理员" /></div>
