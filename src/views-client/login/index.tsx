...
import LoginBackJpg from "@assets/img/bjd.jpg";
        ...
        <Container>
            <Scrollbars>
                ...
                <div className="content">
                    <img src={LoginBackJpg} alt="" width="100%" height="100%" style={{ position: "absolute" }} onError={(e: any) => { e.target.src = LoginBackJpg; }} />
